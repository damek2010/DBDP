...
class MenuS_m extends CI_Model {
	...
	private function menu()
	{
		$this->wynik.= '<div class="panel-body">
						...
						<div class="col-xs-6 col-md-6">
						  <a href="#" class="btn btn-success btn-lg" role="button"><span class="glyphicon glyphicon-list-alt"></span> <br/>Projekty</a>
						  <a href="#" class="btn btn-warning btn-lg" role="button"><span class="glyphicon glyphicon-knight"></span> <br/>Zadania</a>
